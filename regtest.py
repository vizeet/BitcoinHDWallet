...
network = json.load(open('hd_wallet.conf'))['network']
...
def get_priv_pub_key():
        ...
        privkey_wif = pubkey_address.privkeyHex2Wif(privkey_i, network)
        ...
        address_s = pubkey_address.sh2address(hash160_script_b, network)
...
#        print('raw_tx = %s' % raw_tx)
        ...
        print('in_privkey_wif = %s, in_address_s = %s, in_value = %f' % (in_privkey_wif, in_address_s, in_value))
        ...
        print('out_privkey_wif = %s, out_address_s = %s, out_value = %f' % (out_privkey_wif, out_address_s, out_value))
        print('change_privkey_wif = %s, change_address_s = %s, change_value = %f' % (change_privkey_wif, change_address_s, change_value))
